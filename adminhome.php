...
<body id="main-layout" style="border: none;">
    <nav>
        <div class="container">
            ...
            <div class="navigation" style="background-color: white;">
                ...
                <img style="height: 70px; width: 280px;margin-left:-90px" src="images/Savor the Flavor.png" alt="">
                <button style="margin-left: 25px; border-right: none;" class="b-nav">
                ...
                <button style="border-right: none;" class="b-nav">
                    <a href="Displayusers" style="padding-left: 35px; padding-right: 35px;">Users</a>
                </button>
                <button class="b-nav">
    ...
    <div class="above-fold">
        <div class="fold-image">
            <img style="width: 100%; height: 750px;" src="images/pexels-goumbik-952356.jpg" alt="">
            <div style="margin-top: -600px;">
                <h1 style="font-size: 55px; text-align: center; font-style: italic; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Look deeper into our food community</h1>
                <h2 style="font-size: 30px; text-align: center; font-style: italic;">Find Delicious Recipies</h2>
                <div style="text-align: center;">
                    <button class="button">
                        <p><a style="color:black;" href="displayrecipie.php">Recipies</a></p>
                    </button>
                </div>
                <div style="text-align: center;">
                    <button class="button" style="margin-top: 15px; margin-left: 504px;">
                        <p><a style="color:black;" href="Addrecipies.html">Add_Recipies</a></p>
                    </button>
                </div>
            </div>
        </div>
